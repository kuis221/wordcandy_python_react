...
class CardMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        customer, created = Customer.get_or_create(subscriber=subscriber_request_callback(request))
        if not customer.card_kind:
            return redirect("djstripe:start_subscribe")
